    ...
    <div className="projects-container" id="projects">
        ...
        <div className="projects-grid">
            ...
            <div className="project">
                ...
                <a  target="_blank" rel="noreferrer"><h2>WeManage: Real Estate Asset Management</h2></a>
            ...
            <div className="project">
                ...
                <a  target="_blank" rel="noreferrer"><h2>COVID-19 Case Management</h2></a>
            ...
            <div className="project">
                ...
                <a  target="_blank" rel="noreferrer"><h2>Multiple Regression Property Analysis</h2></a>
            ...
            <div className="project">
                ...
                <a  target="_blank" rel="noreferrer"><h2>Programs of Study</h2></a>
